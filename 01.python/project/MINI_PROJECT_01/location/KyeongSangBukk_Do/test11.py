...
def extract_gyeongbuk_auto_companies():
    # 1. 처리할 경상북도 10개 파일 목록
    files = [
        "경상북도 김천시_제조업체 등록현황_20251230.csv",
        "경상북도 문경시_제조업체 현황_20250911.csv",
        "경상북도 성주군_제조업체 현황_20180731.csv",
        "경상북도 성주군_제조업체 현황_20250911.csv",
        "경상북도 안동시_대표홈페이지 제조업체_20251126.csv",
        "경상북도 안동시_제조업공장현황_20250828.csv",
        "경상북도 예천군_제조업체 등록현황_20251208.csv",
        "경상북도 청도군_섬유공장현황_20200806.csv",
        "경상북도 청도군_제조업체현황_20250908.csv",
        "경상북도 포항시_제조업공장현황_20250813.csv"
    ]
    ...
    for file in files:
        ...
        if not filtered_df.empty:
            # 4. 경상북도 지자체별로 제각각인 컬럼명을 공통 컬럼명으로 통일
            ...
            # [생산품] 통일 ('생산품', '생산품목', '주요생산품명', '주력사업(생산품)', '주력생산품')
            ...
            # [주소] 통일 ('공장대표주소(도로명)', '도로명주소', '소재지', '소재지주소', '주소', '공장대표주소', '공장소재지주소')
            addr_cols = ['공장대표주소(도로명)', '도로명주소', '소재지', '소재지주소', '주소', '공장대표주소', '공장소재지주소']
            filtered_df['통합_주소'] = ""
    ...
    if extracted_dataframes:
        ...
        # 저장할 파일명 지정
        output_file = "경상북도_자동차산업_관련_회사목록_통합본.csv"
...
if __name__ == "__main__":
    extract_gyeongbuk_auto_companies()
