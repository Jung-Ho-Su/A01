...
def extract_chungbuk_auto_companies():
    # 1. 처리할 충청북도 9개 파일 목록
    files = [
        "충청북도_음성군_산업단지 입주기업 현황_20250922.csv",
        "충청북도_제조업체 현황_20241231.csv",
        "충청북도 괴산군_공장등록현황_20190904..csv",
        "충청북도 괴산군_지역별 제조업체_20260106.csv",
        "충청북도 단양군_제조업체 현황_20250909.csv",
        "충청북도 보은군_제조업체 현황_20250903.csv",
        "충청북도 옥천군_제조업체 현황_20250903.csv",
        "충청북도 음성군_제조업체 현황_20250831.csv",
        "충청북도 제천시_공장등록현황_20260112.csv"
    ]
    ...
    for file in files:
        ...
        if not filtered_df.empty:
            # 4. 충북 지자체별로 제각각인 컬럼명을 공통 컬럼명으로 통일
            ...
            # [업종명] 통일 ('업종명', '대표업종', '업종구분')
            industry_cols = ['업종명', '업종', '업종구분', '대표업종']
            filtered_df['통합_업종명'] = ""
            ...
            # [주소] 통일 ('공장대표주소', '소재지', '회사주소' 등)
            addr_cols = ['공장대표주소', '공장대표주소(도로명)', '도로명주소', '주소', '소재지주소', '소재지', '회사주소']
            filtered_df['통합_주소'] = ""
    ...
    if extracted_dataframes:
        ...
        # 저장할 파일명 지정
        output_file = "충청북도_자동차산업_관련_회사목록_통합본.csv"
...
if __name__ == "__main__":
    extract_chungbuk_auto_companies()