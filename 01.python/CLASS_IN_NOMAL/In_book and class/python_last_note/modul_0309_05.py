...
os.chdir("c:\\windows")
print(os.getcwd()) # 경로 확인하기
print(os.listdir()) # 목록 확인하기 # dir이 붙어있어 디렉토리 목록을 보여주는 것

## os.chdir("c:\\C:\\Project\\Python_Source\\Python311_01\\python") #다시 경로르 바꿔주기!

# 여기까지가 머신러닝, 딥 러닝을 하는데 필요한 파이썬의 기초에 대한 내용을 다루었다.